...
declare const Examen2VanguardiaApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class Examen2VanguardiaApplication extends Examen2VanguardiaApplication_base {
